...
const PROVIDERS: {
  ...
  },
  {
    ...
    prefix: 'sk-',
    models: ['GPT-5.4', 'GPT-5.4 mini', 'o3', 'o4-mini'],
    description: 'Access GPT-5.4, o3, and the latest OpenAI models.',
  ...
  },
  {
    ...
    prefix: 'gsk_',
    models: ['Llama 4 Maverick', 'DeepSeek R1', 'Mixtral 8x7B'],
  ...
  },
  {
    ...
    prefix: '',
    models: ['Sarvam 105B', 'Sarvam 30B', 'Sarvam-M'],
  ...
  },
  {
    ...
    prefix: 'sk-',
    models: ['SD 3.5 Large', 'SD 3.5 Large Turbo', 'Stable Image Ultra'],
