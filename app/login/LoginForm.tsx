...
// Separate component so useFormStatus works correctly inside the form
function ContinueButton() {
    ...
    return (
        <button
            ...
            disabled={pending}
            className="w-full py-4 rounded-full bg-white text-black font-semibold hover:bg-neutral-200 transition-all active:scale-[0.98] text-[15px] mt-2 shadow-xl shadow-white/5 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
        >
            {pending ? (
                <>
        ...
        <div className="flex flex-col w-full max-w-sm mx-auto">
            ...
            <div className="flex gap-3 mb-8">
                <button
                    ...
                    className="flex-1 flex items-center justify-center gap-3 py-3.5 px-4 rounded-full border border-white/10 hover:bg-white/5 transition-colors text-white font-medium text-sm disabled:opacity-70 disabled:cursor-not-allowed shadow-sm"
                >
                    {isGoogleLoading ? (
                        <>
